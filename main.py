...
print('RMSE: ',metrics.root_mean_squared_error(y_test, d_tree_predictions))
print('MAE: ',metrics.mean_absolute_error(y_test,d_tree_predictions))
print('MSE: ',metrics.mean_squared_error(y_test,d_tree_predictions))
print('R^2: ', metrics.r2_score(y_test,d_tree_predictions))
...
print('R^2: ', metrics.r2_score(y_test,r_forest_predictions))
...
print('R^2: ', metrics.r2_score(y_test,r_forest_grid_predictions))
